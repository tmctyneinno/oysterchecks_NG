                        ...
                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{isset($verifications?->candidate['firstname'])?$verifications?->candidate['firstname']: $verifications->first_name}} {{isset($verifications?->candidate['lastname'])?$verifications?->candidate['lastname']:$verifications->last_name}}  </td>
