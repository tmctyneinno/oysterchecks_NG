                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="row border-bottom mb-5">
                                                    ...
                                                    <div class="col-12 col-md-6 d-flex py-4 border-top">
                                                        ...
                                                        <div class="fw-normal font-15 col-8">{{isset($address_verification?->candidate['firstName'])?$address_verification?->candidate['firstName']: (isset($address_verification?->candidate['firstname'])?$address_verification?->candidate['firstname']: '')}}</div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-md-6 d-flex py-4 border-top">
                                                        ...
                                                        <div class="fw-normal font-15 col-8">{{isset($address_verification?->candidate['middleName'])?$address_verification?->candidate['middleName']: (isset($address_verification?->candidate['middlename'])?$address_verification?->candidate['middlename']: '')}}</div>
                                                    </div>
                                                    @endif
                                                    <div class="col-12 col-md-6 d-flex py-4 border-top">
                                                        <div class="fw-semibold m-0 font-15 me-3 text-muted col-4">Last Name : </div>
                                                        <div class="fw-normal font-15 col-8">{{isset($address_verification?->candidate['lastname'])?$address_verification?->candidate['lastname']: (isset($address_verification?->candidate['lastName'])?$address_verification?->candidate['lastName']:'')}}</div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-md-6 d-flex py-4 border-top">
                                                        ...
                                                        <div class="fw-normal font-15 col-8">{{isset($address_verification?->candidate['mobile'])?$address_verification?->candidate['mobile']: (isset($address_verification?->candidate['phone'])?$address_verification?->candidate['phone']:'')}}</div>
                                                    </div>
                                        ...
                                        <div id="collapseOneTwo" class="accordion-collapse" aria-labelledby="headingOneTwo" data-bs-parent="#guarantorInformation">
                                            <div class="accordion-body">
                                                ...
                                                <div class="row border-bottom mb-5">
                                                    ...
                                                    <div class="col-12 col-md-6 d-flex py-4 border-top">
                                                        <div class="fw-semibold m-0 font-15 me-3 text-muted col-4">First Name : </div>
                                                        <div class="fw-normal font-15 col-8">{{isset($address_verification?->guarantor['firstName'])?$address_verification?->guarantor['firstName']: (isset($address_verification?->guarantor['firstname'])?$address_verification?->guarantor['firstname']: '')}} 
                                                            </div>
                                                    </div>
                                                    <div class="col-12 col-md-6 d-flex py-4 border-top">
                                                        <div class="fw-semibold m-0 font-15 me-3 text-muted col-4">Last Name : </div>
                                                        <div class="fw-normal font-15 col-8">{{isset($address_verification?->guarantor['lastName'])?$address_verification?->guarantor['lastName']: (isset($address_verification?->guarantor['lastname'])?$address_verification?->guarantor['lastname']: '')}} 
                                                         </div>
                                                    </div>
                                                    <div class="col-12 col-md-6 d-flex py-4 border-top">
                                                        <div class="fw-semibold m-0 font-15 me-3 text-muted col-4">Phone : </div>
                                                        <div class="fw-normal font-15 col-8">{{isset($address_verification?->guarantor['mobile'])?$address_verification?->guarantor['mobile']: (isset($address_verification?->guarantor['phone'])?$address_verification?->guarantor['phone']:'')}}
                                                            </div>
                                                    </div>
                                ...
                                <div class="accordion" id="businessInformation">
                                    ...
                                    <div class="row border-bottom mb-5">
                                        <div class="col-12 col-md-6 d-flex py-4 border-top">
                                            ...
                                            <div class="fw-normal font-15 col-8">{{ isset($address_verification?->business['name']) ? $address_verification?->business['name'] 
                                                    : (isset($address_verification?->business['businessName']) 
                                                        ? $address_verification?->business['businessName'] 
                                                        : '') }}
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6 d-flex py-4 border-top">
                                            <div class="fw-semibold m-0 font-15 me-3 text-muted col-4">Contact Person : </div>
                                            <div class="fw-normal font-15 col-8">
                                                {{ isset($address_verification?->business['email']) 
                                                    ? $address_verification?->business['email'] 
                                                    : (isset($address_verification?->business['canContactPoc']) 
                                                        ? $address_verification?->business['canContactPoc'] 
                                                        : '') }}
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6 d-flex py-4 border-top">
                                            <div class="fw-semibold m-0 font-15 me-3 text-muted col-4">Phone : </div>
                                            <div class="fw-normal font-15 col-8">
                                                {{ isset($address_verification?->business['mobile']) 
                                                    ? $address_verification?->business['mobile'] 
                                                    : '' }}
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6 d-flex py-4 border-top">
                                            ...
                                            <div class="fw-normal font-15 col-8">
                                                {{ isset($address_verification?->business['registrationNumber']) 
                                                    ? $address_verification?->business['registrationNumber'] 
                                                    : (isset($address_verification?->business['rcNumber']) 
                                                        ? $address_verification?->business['rcNumber'] 
                                                        : '') }}
                                            </div>
                                        </div>
                                    </div>
