                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-12 py-2">
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body align-self-center">
                                                                <h6 class="m-0 font-15">{{if(isset($note['note']))?$note['note']:$note['comment']}} </h6>
                                                                <p class="mb-0 text-muted font-13">{{if(isset($note['createdAt']))?$note['createdAt']:$note['firstname'] .' '.$note['lastname']}}</p>
                                                            </div>
                                                            <!--end media body-->
                                                        </div>
                                                    </div>
