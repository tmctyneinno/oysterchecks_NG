                             ...
                             <div class="card-body" >
                                 <div class="row d-flex justify-content-center">
                                     <div class="col">
                                         ...
                                         <h3 class="m-0 text-black">{{count($results)??'0'}}</h3>
                                     </div>
                                     <div class="col-auto align-self-center">
                                         <div class="report-main-icon bg-light-alt">
                                             <i data-feather="users" class="align-self-center text-muted icon-sm"></i>
                     ...
                     <div class="card-body">
                         <table id="datatable-buttons" class="table table-striped dt-responsive nowrap " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                             ...
                             <tbody>
                                 ...
                                 {{-- <td>    {{print_r($transaction->addressVerificationDetail)}}</td> --}}
                                     <td> @if(count($transaction->addressVerificationDetail) > 0) Verifications Exit @else No verication found @endif </td>
                                     ...
                                     <td>
                                         <div class="dropdown d-inline-block">
                                             ...
                                             <div class="dropdown-menu dropdown-menu-right" aria-labelledby="seeMore" style="">
                                                 <a class="dropdown-item " style="border-bottom: 1px solid #83818154" href="{{route('admin.ViewCandidateAddresses', encrypt($transaction->id))}}">View Verifications</a>
