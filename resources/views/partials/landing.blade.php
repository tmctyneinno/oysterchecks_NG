    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-transparent">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand" href="{{ route('landing') }}">
                <img src="{{ asset('/landing_assets/img/logo-white.png') }}" width="200px" alt="Oysterchecks" class="img-fluid"/>
            </a>
            ...
            <div class="collapse navbar-collapse h-auto justify-content-center" id="navbarSupportedContent">
                <ul class="navbar-nav menu">
                    ...
                    <li>
                        <a href="{{ route('about-us') }}" class="dropdown-toggle">About Us</a>
                        <ul class="sub-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{ route('transaction') }}">Transaction Monitoring</a></li>

                            {{-- GRC & Assurance --}}
                            <li><a href="{{ route('grc-assurance') }}">GRC &amp; Assurance</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('book-a-demo') }}">Book a Demo</a>
                    </li>
